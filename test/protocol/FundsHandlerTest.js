  ...
  context("📋 FundsLib  Methods", async function() {
    ...
    context("👉 encumberFunds()", async function() {
      ...
      context("seller's available funds drop to 0", async function() {
        ...
        it("token should be removed from the token list even if list length - 1 is different from index", async function() {
          // length - 1 is equal index when offerIds length is 1 or index to remove is the last
