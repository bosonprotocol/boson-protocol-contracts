...
describe("IBosonBundleHandler", function () {
  // Common vars
  let InterfaceIds;
  let deployer, rando, operator, admin, clerk, treasury, buyer, other1, other2, other3;
  let erc165,
    protocolDiamond,
    accessController,
    twinHandler,
  ...
  beforeEach(async function () {
    ...
    [deployer, operator, admin, clerk, treasury, rando, buyer, other1, other2, other3] = await ethers.getSigners();
